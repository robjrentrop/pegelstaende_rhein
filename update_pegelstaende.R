...
tryCatch({
  ...
  # WICHTIG: Datum explizit und einheitlich als Text formatieren. Ohne das
  # schreibt write.csv() Zeitstempel, die exakt auf Mitternacht fallen,
  # manchmal ohne Uhrzeit (nur "2026-07-02" statt "2026-07-02 00:00:00"),
  # während der Rest der Spalte die volle Uhrzeit behält. Diese gemischten
  # Formate verwirren Datawrappers automatische Datumserkennung und führen
  # zu "Not enough data to show a line or area chart".
  breit$Datum <- format(breit$Datum, "%Y-%m-%d %H:%M:%S")
